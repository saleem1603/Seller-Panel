    ...
    <>
        ...
        <div className="max-w-[3640px]  flex flex-row items-center justify-between  ">
          <div className=" flex flex-row  gap-[150px] sm:gap-[100px] justify-between items-center  ">
            <div class="flex items-stretch   ">
              ...
              />
              <button className="bg-customPurple  text-white font-bold py-3 px-4 rounded-r-md focus:outline-none  ">
                <ion-icon
                  name="search-outline"
      ...
      bg-white rounded-md shadow-lg fixed  w-[25%] right-[40px] z-10    
        duration-700 ${show ? "top-[80px]" : "top-[-100%]"}`}>
              <div className="flex font-semibold justify-between mb-4 px-3">
            ...
            <div className={`bg-customPurple rounded-full text-white cursor-pointer register-button`}>
